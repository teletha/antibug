...
public class StructuredTypeTest extends JavadocTestSupport {
    ...
    public void topLevelType(String type) {
        assert checkParamType(currentMethod(), "<i class='type'>String</i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void memberType(Thread.State type) {
        assert checkParamType(currentMethod(), "<i class='type'>State</i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void nestedMemberType(ProcessBuilder.Redirect.Type type) {
        assert checkParamType(currentMethod(), "<i class='type'>Type</i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void arrayType(String[] type) {
        assert checkParamType(currentMethod(), "<i class='type' array='fix'>String</i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void vararg(String... type) {
        assert checkParamType(currentMethod(), "<i class='type' array='var'>String</i>");
    }
    ...
    public void parameterizedType(List<String> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>String</i></i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void parameterizedTypes(Map<String, Class> type) {
        assert checkParamType(currentMethod(), "<i class='type'>Map</i><i class='parameters'><i class='type'>String</i>, <i class='type'>Class</i></i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public <T> void parameterizedTypeByVariable(List<T> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>T</i></i>");
    }
    ...
    public void parameterizedTypeByWildcardType(List<?> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>?</i></i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public void parameterizedTypeByLowerBoundedType(List<? extends CharSequence> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>?</i><i class='extends'><i class='type'>CharSequence</i></i></i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public <T> void parameterizedTypeByLowerBoundedVariable(List<? extends T> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>?</i><i class='extends'><i class='type'>T</i></i></i>");
    }
    ...
    public void parameterizedTypeByUpperBoundedType(List<? super CharSequence> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>?</i><i class='super'><i class='type'>CharSequence</i></i></i>");
    }

    @ParameterizedTest
    @ArgumentsSource(NullProvider.class)
    public <T> void parameterizedTypeByUpperBoundedVariable(List<? super T> type) {
        assert checkParamType(currentMethod(), "<i class='type'>List</i><i class='parameters'><i class='type'>?</i><i class='super'><i class='type'>T</i></i></i>");
    }
