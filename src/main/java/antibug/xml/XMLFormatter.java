 ...
 * @see LexicalHandler
 * @see Attributes
 * @version 2014/08/02 0:22:13
 */
public class XMLFormatter implements ContentHandler, LexicalHandler {
    ...
    public XMLFormatter(OutputStream stream) {
        this(new OutputStreamWriter(stream, I.$encoding));
    }
    ...
    public XMLFormatter(Writer writer) {
        this((Appendable) new BufferedWriter(writer));
    }
