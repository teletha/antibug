...
public class LocalVariablesSorter extends MethodVisitor {
     ...
     * {@link MethodVisitor#visitFrame}, except that long and double types use two slots.
     */
    ...
    /**
     * Constructs a new {@link LocalVariablesSorter}. <i>Subclasses must not use this
     ...
     * @param methodVisitor the method visitor to which this adapter delegates calls.
     */
    protected LocalVariablesSorter(final int api, final int access, final String descriptor, final MethodVisitor methodVisitor) {
